		...
		<div class="x_panel">
			...
			<div class="x_content">
			    ...
			    <ul>
					...
					<li><button type="submit" class="btn btn-primary" name="selectgo" value="selectGo"> 查 &nbsp;&nbsp;&nbsp;&nbsp;询 </button></li>
				</ul>
			</form>
		</div>
	</div>
				...
				<div class="row">
					<div class="col-sm-5">
						<div class="dataTables_info" id="datatable-responsive_info"
							role="status" aria-live="polite">共${ appInfoList.pages }条记录
							...
							<ul class="pagination">
								<c:if test="${appInfoList.pageNum > 1}">
									<li class="paginate_button previous">
										<a href="javascript:page_nav(document.forms[0],1);" aria-controls="datatable-responsive" data-dt-idx="0" tabindex="0">首页</a>
									</li>
