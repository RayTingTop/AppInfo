...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
         <div class="clearfix"></div>
        <form id="devuserform" class="form-horizontal form-label-left" action="devuserupdatesave" method="post">
        <input type="number" name="id" value="${devUserSession.id}" readonly="readonly" hidden>
          <div class="item form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">登录名 <span class="required">*</span>
            </label>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="devCodeUpdate" class="form-control col-md-7 col-xs-12" 
               data-validate-length-range="20" data-validate-words="1" name="devCode"  required="required"
                type="text" value="${devUserSession.devCode}" readonly="readonly">
            </div>
          </div>
          <div class="item form-group">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="devPassword" class="form-control col-md-7 col-xs-12" 
              	...
              	placeholder="${devUserSession.devPassword}" type="text" value="${devUserSession.devPassword}">
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="reDevPassword" class="form-control col-md-7 col-xs-12" 
              	...
              	placeholder="请再次输入密码,确认密码无误" type="text" value="${devUserSession.devPassword}">
            </div>
          </div>
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <input id="devEmail" class="form-control col-md-7 col-xs-12" name="devEmail" 
              	...
              	placeholder="请输入Email(非必填)" type="text" value="${devUserSession.devEmail}">
            </div>
          </div>
	      ...
	      <div class="item form-group">
	          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="textarea">用户简介 <span class="required">*</span>
	           ...
	           <div class="col-md-6 col-sm-6 col-xs-12">
	             <textarea id="devInfo" name="devInfo" placeholder="请输入开发人员的相关信息(非必填)" 
	             	class="form-control col-md-7 col-xs-12">${devUserSession.devInfo}</textarea>
	          </div>
	      </div>
          </div>
          <div class="item form-group">${fileUploadError }</div>
          </div>
